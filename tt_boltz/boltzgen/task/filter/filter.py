...
from tt_boltz.boltzgen.task.analyze.analyze_utils import compute_liability_scores
from tt_boltz.boltzgen.task.filter.seqplot_utils import (
    aa_composition_pie,
    cdr_logo,
...
class Filter(Task):
    ...
    **Diversity.** A lazy-greedy selection chooses `div_budget` designs maximizing:
    ...
    Examples
    --------
    >>> from tt_boltz.boltzgen.task.filter.filter import Filter
    >>> filter = Filter(
