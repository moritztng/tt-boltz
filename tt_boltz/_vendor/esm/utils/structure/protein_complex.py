...
from tt_boltz._vendor.esm.utils.structure.mmcif_parsing import MmcifWrapper, NoProteinError
from tt_boltz._vendor.esm.utils.structure.protein_chain import (
    ProteinChain,
    _str_key_to_int_key,
    chain_to_ndarray,
    index_by_atom_name,
