...
from tt_boltz._vendor.esm.utils import residue_constants
from tt_boltz._vendor.esm.utils.misc import slice_python_object_as_numpy
from tt_boltz._vendor.esm.utils.structure.affine3d import Affine3D
from tt_boltz._vendor.esm.utils.structure.aligner import Aligner
from tt_boltz._vendor.esm.utils.structure.atom_indexer import AtomIndexer
from tt_boltz._vendor.esm.utils.structure.metrics import compute_gdt_ts, compute_lddt_ca
from tt_boltz._vendor.esm.utils.structure.mmcif_parsing import MmcifWrapper, Residue
from tt_boltz._vendor.esm.utils.structure.normalize_coordinates import (
    apply_frame_to_coords,
    get_protein_normalization_frame,
)
from tt_boltz._vendor.esm.utils.structure.protein_structure import index_by_atom_name
from tt_boltz._vendor.esm.utils.types import PathOrBuffer
