...
from tt_bio.boltzgen.task.analyze.analyze_utils import compute_liability_scores
from tt_bio.boltzgen.task.filter.seqplot_utils import (
    aa_composition_pie,
    cdr_logo,
...
class Filter(Task):
    ...
    **Diversity.** A lazy-greedy selection chooses `div_budget` designs maximizing:
    ...
    Examples
    --------
    >>> from tt_bio.boltzgen.task.filter.filter import Filter
    >>> filter = Filter(
